# Final voiceover — 1:45

Read this like you are showing a clever friend a product you wish had always
existed: direct, warm, slightly quick, and never in advertisement voice. The
limitation at 01:19 should be calm and matter-of-fact. Aim for 145–155 words
per minute.

If recording a human take, export it as `film/voiceover.wav`,
`film/voiceover.m4a`, or `film/voiceover.mp3`, starting at 00:00. The assembler
automatically prefers it over generated clips.

| In | Read |
|---:|---|
| 00:00.5 | Ada paid nine thousand six hundred for the group. Now she is the debt collector. |
| 00:06.5 | Eleven days. Four reminders. Seven thousand two hundred unpaid. |
| 00:11.3 | What if nobody had to pay first? |
...
| 00:51.5 | Ask Sutra who is missing, and it answers from the group's real state. |
...
- Keep breaths natural; remove only distracting gaps longer than 300 ms.
- Do not boost treble or add “presence.” The film mix already leaves room for speech.
- Peak below −1 dBTP and target roughly −16 LUFS integrated for the voice master.
- Listen once on laptop speakers and once on headphones before exporting.
