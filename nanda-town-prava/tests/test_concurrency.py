...
async def test_concurrent_pay_by_the_same_agent_cannot_overspend_its_cap() -> None:
    ...
    assert payments.balance(AgentId("buyer-0")) == 40, "60 captured, 3 released, nothing double-spent"
...
async def test_engine_unreachable_at_creation_leaves_no_partial_state() -> None:
    ...
    assert payments.authorization(PaymentRef("p1")) is None, "never authorized -- ref is free to retry"
